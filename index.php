...
<?php
    ...
    <div class="container">
        <div class="header">
            ...
            <form class="logo" action="index.php" method="POST" onclick="resetPage()" id="logoReset">
                <h3>Foodies</h3>
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            if($row['in_stock'] == 0) {
                                ...
                                if (isset($_SESSION['cart'][$product_id]['quantity'])) {
                                    $quantity_in_cart = $_SESSION['cart'][$product_id]['quantity'];
                                } else {
                                    $quantity_in_cart = 0;
                                }
                                $remaining_stock = $row['in_stock'] - $quantity_in_cart;
                                ...
                                if ($remaining_stock <= 0) {
                                    ...
                                    echo 'Quantity: <input type="number" name="quantity" value="0" min="1" max="'. $remaining_stock . '"><br>';
                                    echo '<button class="addCartBtn" type="submit" name="add_to_cart"';
                                    if ($remaining_stock === 0) {
                                        echo ' disabled';
                                    }
